...
const CheckoutModal: React.FC<CheckoutModalProps> = ({ isOpen, onClose, onSuccess, price }) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-[70] flex items-center justify-center p-4 bg-slate-900/90 backdrop-blur-sm transition-opacity duration-400 ease-luxury ${isOpen ? 'opacity-100' : 'opacity-0'
        }`}
    >
      <div
